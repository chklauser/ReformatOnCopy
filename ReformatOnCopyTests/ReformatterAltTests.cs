...
public class ReformatterAltTests
{
    ...
    public void Setup()
    {
        reformatter = new(detector: Reformatter.BreakDetector.Alternative);
    }
    ...
    {
        // Act
        var result = reformatter.ReformatAlt(@"Nothing should change in a single line.");
    ...
    {
        // Act
        var result = reformatter.ReformatAlt("Line break in\nthe middle of a sentence.");
    ...
    {
        // Act
        var result = reformatter.ReformatAlt("Dashes that are in- \n volved in splitting.");
    ...
    {
        // Act
        var result = reformatter.ReformatAlt("End. \n And beginning.");
    ...
    {
        // Act
        var result = reformatter.ReformatAlt("1577 AZ \n Weight: 1.5 Kg.");
    ...
    {
        // Act
        var result = reformatter.ReformatAlt("only one thing \n to do: hold the door.");
